const emitter = require('../..//utils/bird/emitter.js');
...
function wxBird(opts) {
    ...
    var birds = this.birds = ["../../../img/bird/images/0.gif", "../../../img/bird/images/1.gif", "../../../img/bird/images/2.gif"];

    var back = this.back = new Background(ctx, 0, 0, 400, 600, "../../../img/bird/images/bg.png");
    var up_pipe = this.up_pipe = new UpPipe(ctx, 0, 0, 100, 200, "../../../img/bird/images/pipe.png");
    var down_pipe = this.down_pipe = new DownPipe(ctx, 0, 400, 100, 200, "../../../img/bird/images/pipe.png");
    var ground = this.ground = new Background(ctx, 0, 550, 400, 200, "../../../img/bird/images/ground.png");
